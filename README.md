...
Install `curl-i18n`, then install the localization package for each language you need (see [curl-l10n](https://github.com/eoan-ermine/curl-l10n)). Once installed, `curl_easy_strerror` will return error messages in the language specified by the current locale.
